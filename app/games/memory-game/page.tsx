...
import { 
  ...
  Phone, 
  Trophy, 
  Sparkles, // Using Sparkles for "Mind/Magic" vibe
  Grid,     // Grid icon for the cards layout
} from "lucide-react";
...
export default function MemoryGamePage() {
  return (
    <main className="min-h-screen bg-[#0f0518] text-white relative overflow-hidden">
      ...
      {/* Floating Blobs (Cyan/Indigo for Focus/Mind) */}
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 relative z-10">
        ...
        >
          <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
            ...
            <div>
              <h1 className="text-4xl md:text-6xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-cyan-200 to-indigo-500 mb-2">
                Memory Game
              </h1>
              <p className="text-xl text-gray-400 max-w-2xl">
                Flip. Match. Win. Test your visual memory and teamwork skills in this classic concentration challenge.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <Card className="bg-white/5 border-white/10 backdrop-blur-md">
              <CardContent className="p-6 space-y-4">
                <h3 className="text-xl font-bold text-white flex items-center gap-2">
                  [cite_start]<Trophy className="w-5 h-5 text-yellow-400" /> Game Structure [cite: 86]
                </h3>
                <p className="text-gray-300 leading-relaxed">
                  A set of cards will be laid out face down. Your team must find matching pairs based on memory alone. Speed and coordination are key!
                </p>
                <div className="space-y-3 pt-2">
                  <div className="flex gap-3">
                    <Badge variant="outline" className="border-cyan-500 text-cyan-400 h-fit mt-1">Setup</Badge>
                    <div>
                      <h4 className="font-semibold text-white">3 Tables</h4>
                      [cite_start]<p className="text-sm text-gray-400">The game will be conducted simultaneously on 3 tables, one team per table. [cite: 93, 94]</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <Badge variant="outline" className="border-indigo-500 text-indigo-400 h-fit mt-1">Round</Badge>
                    <div>
                      <h4 className="font-semibold text-white">Single Round</h4>
                      <p className="text-sm text-gray-400">Only one round will be conducted. [cite_start]Make it count! [cite: 100]</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="space-y-4">
              [cite_start]<h3 className="text-2xl font-bold text-white">Rules & Regulations [cite: 95]</h3>
              <ul className="grid gap-3">
                {[
                  "Cards will be shown face-up for 30 seconds only.",
                  "After 30 seconds, cards are flipped face down.",
                  "Teams get 1 minute to find all matching pairs.",
                  "Team members must play alternately (take turns flipping).",
          ...
          >
            ...
            <Card className="bg-gradient-to-br from-cyan-500/10 to-indigo-500/10 border-cyan-500/30">
              <CardContent className="p-6 text-center">
                <h3 className="text-lg font-semibold text-cyan-200 mb-1">Entry Fee</h3>
                <p className="text-4xl font-bold text-cyan-400">₹30</p>
                [cite_start]<p className="text-sm text-cyan-200/60 mt-2">Per Team [cite: 91]</p>
              </CardContent>
            </Card>
