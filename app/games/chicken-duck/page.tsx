...
export default function ChickenDuckPage() {
  return (
    <main className="min-h-screen bg-[#0f0518] text-white relative overflow-hidden">
      <StarBackground />
      <div className="fixed top-0 right-0 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-yellow-600/20 rounded-full blur-[100px] -z-10 pointer-events-none" />
      <div className="fixed bottom-0 left-0 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-green-600/20 rounded-full blur-[100px] -z-10 pointer-events-none" />
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8 sm:mb-12 text-center md:text-left">
          <div className="flex flex-col md:flex-row gap-4 sm:gap-6 items-center md:items-start">
            <div className="p-3 sm:p-4 bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl shrink-0">
              <Ghost className="w-8 sm:w-12 h-8 sm:h-12 text-yellow-500" />
            </div>
            <div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-yellow-200 to-green-500 mb-2">
                Chicken Duck
              </h1>
              <p className="text-sm sm:text-base md:text-lg text-gray-400 max-w-2xl">
                A fun-filled group game designed for quick thinking and active participation.
              </p>
            </div>
          </div>
        </motion.div>
            ...
            <Card className="bg-white/5 border-white/10 backdrop-blur-md">
              <CardContent className="p-4 sm:p-6 space-y-4">
                ...
                <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                  A chaotic survival game played in a limited area. One player is blindfolded and given a sponge stick to hunt the others.
                </p>
                <div className="space-y-2 sm:space-y-3 pt-2">
                  <div className="flex gap-2 sm:gap-3">
                    <Badge variant="outline" className="border-yellow-500 text-yellow-400 h-fit mt-0.5 sm:mt-1 text-xs sm:text-sm shrink-0">Gameplay</Badge>
                    <div className="min-w-0">
                      <h4 className="font-semibold text-white text-sm sm:text-base">Blindfolded Tag</h4>
                      <p className="text-xs sm:text-sm text-gray-400">The blindfolded player must hit others using the sponge stick.</p>
                    </div>
                  </div>
                  <div className="flex gap-2 sm:gap-3">
                    <Badge variant="outline" className="border-green-500 text-green-400 h-fit mt-0.5 sm:mt-1 text-xs sm:text-sm shrink-0">Duration</Badge>
                    <div className="min-w-0">
                      <h4 className="font-semibold text-white text-sm sm:text-base">15 Minutes</h4>
                      <p className="text-xs sm:text-sm text-gray-400">Each registered team gets 15 minutes of playtime.</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <ul className="space-y-2 sm:space-y-3">
                {[
                  ...
                  "The blindfolded player must hit other players using the stick.",
                  "Players must stay within the allotted limited area.",
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }} className="space-y-4 sm:space-y-6">
            <Card className="bg-gradient-to-br from-yellow-500/10 to-green-500/10 border-yellow-500/30">
              <CardContent className="p-4 sm:p-6 text-center">
                <h3 className="text-sm sm:text-lg font-semibold text-yellow-200 mb-1">Entry Fee</h3>
                <p className="text-3xl sm:text-4xl font-bold text-yellow-400">₹50</p>
                <p className="text-xs sm:text-sm text-yellow-200/60 mt-2">Per Player</p>
              </CardContent>
            </Card>
            ...
            <div className="w-full bg-white/5 border border-white/10 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-400 text-sm mb-4">
                This is a spot event. Please visit Room 401 to register.
              </p>
